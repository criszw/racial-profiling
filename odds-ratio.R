...
#Since p-value is 0.01705 there is considerable evidence at 5% significance level that there 
#is an association between skin color and being stopped by TSA. 
